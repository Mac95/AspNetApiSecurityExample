...
namespace AspNetApiSecurity.Controllers
{
    ...
    {
        protected string urlBase = "http://localhost:58981/api/account/";
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            try
            {
                ...
                // ok means: authentication was successfull
                if (ok != null)
                {
            ...
            // var cnt = ControllerBuilder.Current.GetControllerFactory().CreateController(Request.RequestContext, "ApiAccountController");
            ...
            //var api = new ApiAccountController();
